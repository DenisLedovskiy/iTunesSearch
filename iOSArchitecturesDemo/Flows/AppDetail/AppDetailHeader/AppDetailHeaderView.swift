...
final class AppDetailHeaderView: UIView {
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.imageView.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 12.0), self.imageView.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 16.0),
